import fetch from 'node-fetch' // Asegúrate de tener esto arriba
...
`.trim()
  ...
  let img = 'https://files.catbox.moe/0ocrpt.png'
    ...
    quoted: {
      ...
      message: {
        extendedTextMessage: {
          text: info,
          matchedText: info,
          canonicalUrl: 'https://syateam.com',
          title: 'SYA TEAM SURVIVALS',
          description: 'Únete a la comunidad Survival',
          jpegThumbnail: thumb
        }
      }
    }
