  ...
  for (let owner of owners) {
    ...
    cards.push({
      ...
      footer: proto.Message.InteractiveMessage.Footer.fromObject({
        text: '> 🍿 Conoce más sobre nuestros creadores siguiendo sus redes sociales. Haz clic en cualquier botón para acceder a sus perfiles y descubrir su trabajo. Si te gustaría apoyarlos, puedes dejar tu estrellita en el repo : https://github.com/Ado-rgb/Michi-WaBot'
      }),
