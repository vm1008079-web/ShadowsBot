...
if (prohibited.some(word => m.text.toLowerCase().includes(word))) return m.reply('Deja de buscar eso puto enfermo de mierda, por eso te encannta la paja.').then(_ => m.react('✖️'))
await m.react('🕓')
try {
